...
<section class="bg-white pt-16 pb-0">
  <div class="max-w-[1400px] mx-auto px-6 mb-12">
    <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
      ...
      <div class="md:col-span-3 pt-2">
        <p class="text-gray-500 text-lg font-light leading-tight">Heirloom quality,<br>built to last.</p>
      </div>

      <!-- Center -->
      <div class="md:col-span-6 flex justify-center">
        <h1 class="text-[120px] md:text-[160px] leading-none font-light tracking-tighter -mt-8">Crafted</h1>
      </div>

      <!-- Right -->
      <div class="md:col-span-3 pt-4">
        <p class="text-gray-600 text-[15px] leading-relaxed mb-4">
          Custom furniture through<br>
          traditional joinery and<br>
          rare wood species.
        </p>
        <a href="#" class="text-[13px] font-medium text-gray-900 hover:text-gray-600 transition-colors flex items-center gap-1">
          Explore our work <span class="text-[10px]">></span>
        </a>
      </div>
    </div>
  </div>
  ...
  <div class="w-full h-[600px] bg-gray-200 overflow-hidden relative">
    <img 
      src="/generated/image-elegant-handcrafted-wooden-dining-table--1765468711179-0.webp" 
